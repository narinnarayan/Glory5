...
public class Play_listMatch {
    ...
    @Expose
    private List<Object> homeTeam = null;
    @SerializedName("awayTeam")
    @Expose
    private List<Object> awayTeam = null;
    ...
    public List<Object> getHomeTeam() {
        return homeTeam;
    }

    public void setHomeTeam(List<Object> homeTeam) {
        this.homeTeam = homeTeam;
    }

    public List<Object> getAwayTeam() {
        return awayTeam;
    }

    public void setAwayTeam(List<Object> awayTeam) {
